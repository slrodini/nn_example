                 ...
                 void (*fgrad)(double[], size_t, void *, double *, double *))
{
   ...
   aP = (nn_adam_parameters_t){.alpha = 0.03, .beta1 = 0.9, .beta2 = 0.95, .max_it = 30 * 1e+2, .change_learn = 2500, .df_toll = 1e-6};
   (void)nn_adam2(par, nPar, addPar, fgrad, &aP);
   aP = (nn_adam_parameters_t){.alpha = 0.01, .beta1 = 0.9, .beta2 = 0.99, .max_it = 2 * 1e+3, .change_learn = 2000, .df_toll = 1e-6};
   (void)nn_adam2(par, nPar, addPar, fgrad, &aP);
   aP = (nn_adam_parameters_t){.alpha = 1e-4, .beta1 = 0.9, .beta2 = 0.9998, .max_it = 2 * 1e+3, .change_learn = 1000, .df_toll = 1e-6};
